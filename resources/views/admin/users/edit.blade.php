                    ...
                    <form method="POST" action="{{ route('admin.users.update', $user->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <x-text-input id="name" class="block w-full" type="text" name="name" :value="old('name', $user->name)" required autofocus />
                            ...
                            <div class="space-y-2">
                                ...
                                <x-text-input id="email" class="block w-full" type="email" name="email" :value="old('email', $user->email)" required />
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    ...
                                    <x-input-label for="password" :value="__('Password (Biarkan kosong jika tidak ingin mengubah)')" class="text-gray-700 dark:text-gray-300" />
                                </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <select id="role" name="role" class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500" required>
                                    <option value="is_admin" {{ old('role', $user->role) == 'is_admin' ? 'selected' : '' }}>Admin</option>
                                    <option value="is_karyawan" {{ old('role', $user->role) == 'is_karyawan' ? 'selected' : '' }}>Karyawan</option>
                                </select>
